  ...
  render() {
    ...
    return (
       <div className="container">
        <div className="main">
          <h1 style={divStyle}> <strong>Stage Coast </strong> </h1>
          <br/>
            <h5 style={divStyle}>Social Media App where you can view the portfolios of other interior decorators/stagers.</h5>
